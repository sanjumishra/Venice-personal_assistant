# Venice :Personal Assistant
Venice is a desktop AI assistant built using Python that can perform various tasks such as answering questions like ChatGPT, opening desktop applications, browsing websites. This project is designed to be versatile and extensible, with the ability to add more functionalities easily. It integrates the Hugging Face API, a free ChatGPT alternative to simulate conversation, and offers multiple activation methods for user commands.

# Features

* **Voice Activation:** Activate Venice by saying "Venice."
* **Text Input:** Type your queries and press enter to receive a response.
* **App Control:** Open applications like youtube and browser.
* **Website Navigation:** Open websites like chrome and Canva.
...
**Clone the Repository:**
   ```bash
   git clone https://github.com/yourusername/venice-personal_assistant.git
   cd venice-personal_assistant
```

## Usage

### Activating the Assistant
There are several ways to activate Venice:

- **Voice Activation:** Simply say "Venice."
...
#### Query Answering
Ask Venice questions, and she'll answer using the Hugging Face API, a free ChatGPT alternative.
